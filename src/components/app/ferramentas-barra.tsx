...
import { Clapperboard, MapPin, Pickaxe, Scissors, Sparkles, Stamp } from "lucide-react";
import { BarraFerramentas } from "@/components/app/barra-ferramentas";
import type { ItemDock } from "@/components/app/lab-dock";

/**
 * Barrinha flutuante do grupo "Ferramentas": as mesmas seis telas do submenu da
...
/** tela de apresentação do grupo (a porta de entrada, que explica as 6). */
